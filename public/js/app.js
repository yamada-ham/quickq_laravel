    ...
    value: function createCategory() {
      if ($(".childInCreateCategoryBox") != null) {
        ...
        if ($('.parentCategory').val() == null) {
          ...
          var val1 = $('.parentCategory').val(); //削除された要素をもとに戻すため.html(original)を入れておく
...
__webpack_require__(/*! /Users/yamada/Documents/htdocs/quickq_laravel/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/yamada/Documents/htdocs/quickq_laravel/resources/sass/app.scss */"./resources/sass/app.scss");
